...
![High-level business context diagram for the application.](documents/docs/images/02-Context-Vew-Business.png)
...
![High-level use case diagram for the application.](documents/docs/images/01-Use-Case-Diagram.png)
...
![Technical-Context-Vew](documents/docs/images/03-Context-View-Technical.png)
