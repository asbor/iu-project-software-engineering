                ...
                <form @submit.prevent="saveMisc">
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <input type="number" id="batch_size" v-model="misc.batch_size" required
                                placeholder="Optional" class="border-2 border-gray-300 rounded-lg p-2 w-full">
                        </div>
                        <div>
                            <label for="display_amount">Display Amount:</label>
                            <input type="text" id="display_amount" v-model="misc.display_amount" required
                                placeholder="Optional" class="border-2 border-gray-300 rounded-lg p-2 w-full">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="text" id="display_time" v-model="misc.display_time" required
                                placeholder="Optional" class="border-2 border-gray-300 rounded-lg p-2 w-full">
                        </div>
                    </div>
                    <div>
                        <label for="notes">Notes:</label>
                        <textarea id="notes" v-model="misc.notes"
