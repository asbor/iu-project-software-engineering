...
class Styles(Base):
    """
    Represents the styles table in the database.

    Attributes:
        id (UUID): The unique identifier for the styles.
        created_at (DateTime): The timestamp when the styles were created.
        updated_at (DateTime): The timestamp when the styles were last updated.
        name (str): The name of the styles.
        version (int): The version number of the styles.
        category (str): The category of the styles.
        category_number (int): The category number of the styles.
        ...
        notes (str): Additional notes about the styles.
    ...
    recipes = relationship("Recipes", back_populates="style")
