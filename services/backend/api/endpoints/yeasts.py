...
async def get_inventory_yeast(yeast_id: int, db: db_dependency):
...
async def create_inventory_yeast(
        yeast: schemas.InventoryYeastCreate, db: db_dependency):
    try:
...
async def delete_inventory_yeast(id: int, db: db_dependency):
    yeast = db.query(models.InventoryYeast).filter(
...
async def update_inventory_yeast(id: int, yeast: schemas.InventoryYeastCreate, db: db_dependency):
